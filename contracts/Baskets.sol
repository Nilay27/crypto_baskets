...
contract Baskets is Ownable{
    ...
    function resetWeights(string memory _id, uint256[] memory _weights) internal view {
    ...
    function getBasketById(string memory id) internal view returns(Basket memory){
